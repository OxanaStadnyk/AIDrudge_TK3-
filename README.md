...
## 🎓 Сценарій лекції (90 хв)

| Час | Крок | Дія викладача |
|-----|------|---------------|
| 30–35 хв | step1_red | Показати тест → запустити → побачити RED |
| 35–42 хв | step2_green | Написати мінімальний код → GREEN |
| 42–50 хв | step3_refactor | Рефакторинг → тести залишаються GREEN |
| 50–58 хв | step4_extended | Нові вимоги → нові тести → RED знову |
| 58–68 хв | step5_refactor_final | Фінальний дизайн коду |
